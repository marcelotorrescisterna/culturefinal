import global_options_gen as global_options
import pandas as pd
import pickle
...
culture_dictionary.write_dict_to_csv(
    ...
    file_name=str(Path(global_options.OUTPUT_FOLDER, "dict", "expanded_dict_gen.csv")),
)
print("Dictionary saved at {}".format(str(Path(global_options.OUTPUT_FOLDER, "dict", "expanded_dict_gen.csv"))))
